...
df2 = pd.read_csv("../datas/clean_2020_2024.csv")
...
# 단어별 증감 계산
change = pd.concat([mean1, mean2], axis=1, keys=["2015_2019", "2020_2024"]).fillna(0)
change["증감률(%)"] = ((change["2020_2024"] - change["2015_2019"]) / change["2015_2019"].replace(0, 0.0001)) * 100
